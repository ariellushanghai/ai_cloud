...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      drawChart() {
        console.log('lala');
        let chart0 = echarts.init(document.getElementById('overview_chart_0'), null, {renderer: 'svg'});
        let chart1 = echarts.init(document.getElementById('overview_chart_1'), null, {renderer: 'svg'});
        chart0.setOption({
          title: {
